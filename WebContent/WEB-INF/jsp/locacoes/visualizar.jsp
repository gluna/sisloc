		...
		<div id="tabs" class="container">
			...
			<div id="tabs-1">
				...
				<table><tr>
					...
					<td align="left">
						<input	type="text" class="maiuscula" name="llocacao.cliente.nome" value="${locacao.cliente.nome}" readonly /><br>
				...
				<c:forEach items="${locacao.enderecos}" var="endereco" varStatus="status">
					...
					<td align="left">
					<input class="maiuscula" type="text" name="locacao.enderecos[${status.index}].logradouro" size=96 value="${endereco.logradouro}" readonly/>
					</td>
					<td align="right">
					<label>Número:</label>
					</td>
					<td align="left">
					<input class="maiuscula" type="text" name="locacao.enderecos[${status.index}].numero" size=10 value="${endereco.numero}" readonly/>
					<br>
					</td>
					</tr>
					</table>
					...
					<td align="left">
					<input class="maiuscula" type="text" name="locacao.enderecos[${status.index}].complemento" size=50 value="${endereco.complemento}" readonly/>
					<br>
					</td>
					...
					<td align="left">
					<input class="maiuscula" type="text" name="locacao.enderecos[${status.index}].bairro" size=29 value="${endereco.bairro}" readonly/>
					<br>
					</td>
					...
					<td align="left"> 
					<input class="maiuscula" type="text" name="locacao.enderecos[${status.index}].tipoendereco" size=20 value="${endereco.tipoendereco}" readonly/>
					</td>
					</tr>
					</table>
					<br>
					...
					<td align="left">
					<input class="maiuscula" type="text" name="locacao.enderecos[${status.index}].cidade" size=50 value="${endereco.cidade}" readonly/>
					<br>
					</td>
					<td align="right" width="85">
					<label>UF:</label>
					...
					<td align="left">
					<input class="maiuscula" type="text" name="locacao.enderecos[${status.index}].uf" size=26 value="${endereco.uf}" readonly/> 
					<br>
					</td>
					...
					<td align="left">
					<input class="maiuscula" type="text" name="locacao.enderecos[${status.index}].cep" size=12 value="${endereco.cep}" readonly/>
					<br>
					</td>
					</tr>
					</table>
					...
					<td align="left">
					<input class="maiuscula" type="text" name="locacao.enderecos[${status.index}].contato" size=50 value="${endereco.contato}" readonly />
					<br>
					</td>
					</tr>
					</table>
				...
				<table><tr>
					...
					<td align="left"><input	type="text" class="dinheiro" name="locacao.valortotal" value="${locacao.valortotal}" readonly/><br></td>
					<td align="right" width="95"><label>Desconto (%):</label></td>
					<td align="left"><input	type="text" class="maiuscula" name="locacao.descontopercent" value="${locacao.descontopercent}" readonly/><br></td>
					<td align="right" width="95"><label>Desconto (R$):</label></td>
					<td align="left"><input	type="text" class="dinheiro" name="locacao.descontovalor" value="${locacao.descontovalor}" readonly/><br></td>
				...
				<table align="center">
					<tr><td>
					<a href="<c:url value="/locacoes/editar/${locacao.id}" />" name="editar">Editar</a>	
					</td>
					<td>
