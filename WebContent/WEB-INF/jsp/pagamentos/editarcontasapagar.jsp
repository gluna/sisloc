				...
				<fieldset id="nome_cliente" style="width: 1140px;">
					...
					<table>
						<tr>
							...
							<td align="left"><input type="text" class="text" name="pagamento.dtvencimento" value="${pagamento.dtvencimento}" />
							...
							<td align="right" width="95"><label>Dt. Pagamento:</label></td>
							<td align="left"><input type="text" class="text" name="pagamento.dtpagamento" value="${pagamento.dtpagamento}" /> 
